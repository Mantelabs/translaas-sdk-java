 ...
 * README.md}). Delegates to {@link io.translaas.client.TranslaasOptions}.
 */
public final class TranslaasOptions {

  public static final String DEFAULT_API_KEY_HEADER =
      io.translaas.client.TranslaasOptions.DEFAULT_API_KEY_HEADER;

  private final io.translaas.client.TranslaasOptions clientOptions;

  private TranslaasOptions(io.translaas.client.TranslaasOptions clientOptions) {
   ...
   * io.translaas.client.TranslaasClient}.
   */
  public io.translaas.client.TranslaasOptions asClientOptions() {
  ...
  /** Builder mirroring {@link io.translaas.client.TranslaasOptions.Builder} with facade {@link CacheMode}. */
  public static final class Builder {

    private final io.translaas.client.TranslaasOptions.Builder inner =
    ...
    public Builder cacheMode(CacheMode cacheMode) {
      inner.cacheMode(cacheMode != null ? cacheMode.toClient() : io.translaas.client.CacheMode.NONE);
      return this;
    }
    ...
    public Builder offlineCache(io.translaas.client.OfflineCacheOptions offlineCache) {
